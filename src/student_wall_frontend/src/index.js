...
const greetButton = document.getElementById("principal-id");
greetButton.onclick = async (e) => {
  ...
  document.getElementById("principal-id").innerText = "Your Principal ID is " + principal;
...
Alpine.store('events', {
  ...
  const authClient = await AuthClient.create({
    ...
    document.getElementById("principal-id").innerText = principal;  
  },
  async logout() {
    const authClient = await AuthClient.create({
      keyType: "Ed25519"
